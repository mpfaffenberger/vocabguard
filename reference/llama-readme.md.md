...
See UPDATES.md. Also for a running list of frequently asked questions, see the Llama 2 FAQ.
...
2. In the top-level directory run: pip install -e .
...
For common questions, the FAQ can be found on the Meta website which will be kept up to date over time as new questions arise.
